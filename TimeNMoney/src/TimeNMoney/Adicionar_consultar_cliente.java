...
public class Adicionar_consultar_cliente extends javax.swing.JFrame {
     ...
     * @param f
     */
    public Adicionar_consultar_cliente(Funcionario f) {
        initComponents();
        ...
        text_area_notas.setEditable(false);
	...
	private void carrega_lista(){
        ...
        while (rs.next()){
            ...
            et.set_id(id);
            et.set_nome(nome);            
            et.set_morada(morada);
            et.set_contactos(contactos);
            et.set_notas(notas);
            lista_aux.add(et);
            dlm.addElement(nome);
            
        }
        lista_clientes.setModel(dlm);
        this.lista = lista_aux;
        lista_clientes.addListSelectionListener(new ListSelectionListener() {
	...
	private int save_bd(boolean novo){
        ...
        String morada = text_field_morada.getText();
        String contactos = text_field_contactos.getText();
        ...
        if (exist_bd!=0){
            if (!this.novo && (exist_id_bd(id)==0 || id.equals(id_auxiliar))){
                sql = "update tnm_trf_cliente set id = '"+id+"', nome = '"+
                        nome+"', morada = '"+morada+"', contactos = '" + contactos + "', notas = '"+ notas 
                        +"' where id = '" +this.id_aux+ "'";
                DefaultListModel d = new DefaultListModel();
                for (Cliente et : this.lista){
                    if (et.get_id().equals(this.id_aux)){
                        et.set_id(id);
                        et.set_nome(nome);
                        et.set_morada(morada);
                        et.set_contactos(contactos);
            ...
            sql = "insert into tnm_trf_cliente (id,nome,morada,contactos,notas) values ('"+id+"','"+nome+"','"+morada+"','"+contactos+"','"+notas+"')";
            Cliente e = new Cliente();
            e.set_id(id);
            e.set_nome(nome);
            e.set_morada(morada);
            e.set_contactos(contactos);
            e.set_notas(notas);
            this.lista.add(e);
            DefaultListModel d = new DefaultListModel();
            for (Cliente et : this.lista)
        ...
        etiqueta_label.setText("Cliente: "+ nome);
        botao_cancelar.setVisible(false);
        botao_guardar.setVisible(false);
    ...
    public void change_panel(){
        if (this.alteracoes==0)
        {
            ...
            if (!lista_clientes.isSelectionEmpty()){
                String n_aux = lista_clientes.getSelectedValue().toString();
                for (Cliente e : this.lista){
                    if (e.get_nome().equals(n_aux))
                    {
                        id = e.get_id();
                        nome = n_aux;
                        morada = e.get_morada();
                        contactos = e.get_contactos();
                        notas = e.get_notas();
                        this.id_aux = id;
                    }
                }
                etiqueta_label.setText("Cliente: "+ nome);
                text_field_id.setText(String.valueOf(id));
                text_field_nome.setText(nome);
                text_field_morada.setText(morada);
                text_field_contactos.setText(contactos);
                text_area_notas.setText(notas);
	...
	private void initComponents() {
        ...
        text_area_notas = new javax.swing.JTextArea();
        jLabel2 = new javax.swing.JLabel();
        text_field_morada = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        text_field_contactos = new javax.swing.JTextField();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TimeNMoney/customer_item.png"))); // NOI18N
        jLabel1.setText("Adicionar/Consultar Cliente");
        ...
        text_area_notas.setColumns(20);
        text_area_notas.setLineWrap(true);
        text_area_notas.setRows(5);
        jScrollPane2.setViewportView(text_area_notas);
        			...
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(painel_etapaLayout.createSequentialGroup()
        					.addGroup(painel_etapaLayout.createParallelGroup(Alignment.TRAILING, false)
        						...
        						.addComponent(jLabel5, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE))
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        						.addComponent(text_field_nome, GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)
        						.addComponent(text_field_id, GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)
        						.addComponent(text_field_morada, GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)
        						.addComponent(text_field_contactos, GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)
        						.addComponent(jScrollPane2, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)))
        				.addGroup(painel_etapaLayout.createSequentialGroup()
        					.addComponent(etiqueta_label, GroupLayout.PREFERRED_SIZE, 474, GroupLayout.PREFERRED_SIZE)
        					.addGap(18)
        					.addComponent(botao_eliminar, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
        	...
        	painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(painel_etapaLayout.createSequentialGroup()
        			...
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.BASELINE)
        				...
        				.addComponent(text_field_morada, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addGap(18)
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel6)
        				.addComponent(text_field_contactos, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addGap(18)
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addGap(18)
        					.addComponent(painel_etapa, GroupLayout.DEFAULT_SIZE, 636, Short.MAX_VALUE))
        				.addGroup(layout.createSequentialGroup()
    ...
    private void botao_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_alterarActionPerformed
        ...
        text_area_notas.setEditable(true);
        botao_alterar.setVisible(false);
        botao_eliminar.setVisible(false);
    ...
    private void botao_novaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_novaActionPerformed
        ...
        text_field_morada.setText("");
        text_field_contactos.setText("");
        text_area_notas.setText("");
        etiqueta_label.setText("Novo cliente");
        botao_cancelar.setVisible(true);
        botao_guardar.setVisible(true);
        text_field_id.setEditable(true);
        text_field_nome.setEditable(true);
    ...
    @SuppressWarnings("rawtypes")
	private javax.swing.JList lista_clientes;
    private javax.swing.JPanel painel_etapa;
    private javax.swing.JTextArea text_area_notas;
    private javax.swing.JTextField text_field_contactos;
    private javax.swing.JTextField text_field_id;
    private javax.swing.JTextField text_field_morada;

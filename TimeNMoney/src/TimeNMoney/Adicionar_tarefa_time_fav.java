...
public class Adicionar_tarefa_time_fav extends javax.swing.JFrame {
    String username;
    ...
    public Adicionar_tarefa_time_fav(String username, Data_manager dm) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TimeNMoney/add_fav.png"))); // NOI18N
        jLabel10.setText("Adicionar Tarefa Favoritos");
        	...
        	layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(layout.createSequentialGroup()
        					.addGap(36)
        					.addComponent(jLabel11, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(combo_box_cliente, 0, 289, Short.MAX_VALUE))
        				.addGroup(layout.createSequentialGroup()
        					.addGap(36)
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(layout.createSequentialGroup()
        							...
        							.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        								...
        								.addComponent(etapa_combo_box, 0, 289, Short.MAX_VALUE)
        								.addComponent(projecto_combo_box, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        								.addComponent(actividade_combo_box, Alignment.LEADING, 0, 289, Short.MAX_VALUE)
        								.addComponent(descActField, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)))
        						.addGroup(layout.createSequentialGroup()
        							.addGroup(layout.createParallelGroup(Alignment.LEADING)
        								.addComponent(jLabel10)
        								.addGroup(layout.createSequentialGroup()
        									.addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
        										.addComponent(jLabel8, GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
        										.addComponent(jLabel7, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        										.addComponent(jLabel9, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        									.addGap(4)
        									.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        										.addComponent(descTarefaField, GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
        										.addComponent(local_combo_box, 0, 289, Short.MAX_VALUE)
        										.addGroup(layout.createSequentialGroup()
...
//            }
    ...
    private void set_to_dm(String id, TarefaHoras t){
        //TarefaHoras t_aux = this.dm.get_lista_tarefas_favoritas().get(id);
        boolean existe = false;
        for (TarefaHoras aux : this.dm.lista_tarefas_favoritas)
            if (aux.get_id().equals(t.get_id()))
                existe = true;
        
        //if (!this.dm.get_lista_tarefas_favoritas().contains(t))
        if (!existe)
        {

...
public class Adicionar_consultar_actividade extends javax.swing.JFrame {
    ArrayList<Actividade> lista;
    String id_aux;
     ...
     * @param f
     */
    public Adicionar_consultar_actividade(Funcionario f) {
        initComponents();
	...
	private void carrega_lista(){
        ArrayList<Actividade> lista_aux = new ArrayList<>();
        DefaultListModel dlm = new DefaultListModel();
        try{
        Connection con = (new Connection_bd(this.funcionario.get_username())).get_connection();
                
        String sql = "select * from tnm_trf_actividade";
        ...
        lista_actividades.setModel(dlm);
        this.lista = lista_aux;
        lista_actividades.addListSelectionListener(new ListSelectionListener() {
    ...
    private int exist_id_bd(String id){
        try{
            Connection con = (new Connection_bd(this.funcionario.get_username())).get_connection();
            String sql = "select * from tnm_trf_actividade where id = '" + id + "'" ;
            PreparedStatement ps=con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if (rs.next())
                return 1;
	...
	private int save_bd(boolean novo){
        ...
        if (exist_bd!=0){
            if (!this.novo && (exist_id_bd(id)==0 || id.equals(id_auxiliar))){
                  sql = "update tnm_trf_actividade set id = '"+id+"', nome = '"+nome+"', descricao = '"+desc+"' where id = '" +this.id_aux+ "'";
                DefaultListModel d = new DefaultListModel();
                for (Actividade et : this.lista){
            ...
            sql = "insert into tnm_trf_actividade (id,nome,descricao) values ('"+id+"','"+nome+"','"+desc+"')";
            Actividade e = new Actividade();
            e.set_id(id);
            e.set_nome(nome);
        ...
        ps.executeUpdate();
        this.alteracoes = 0;
        lista_actividades.setEnabled(true);
        etiqueta_label.setText("Actividade: "+ nome);
        botao_cancelar.setVisible(false);
        botao_guardar.setVisible(false);
    ...
    public void change_panel(){
        if (this.alteracoes==0)
        {
            ...
            String nome = "";
            String descricao = "";
            if (!lista_actividades.isSelectionEmpty()){
                String n_aux = lista_actividades.getSelectedValue().toString();
                for (Actividade e : this.lista){
                ...
                etiqueta_label.setText("Actividade: Nenhuma actividade seleccionada");
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TimeNMoney/activity_icon.png"))); // NOI18N
        jLabel1.setText("Adicionar/Consultar Actividade");
        	...
        	painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(painel_etapaLayout.createSequentialGroup()
        			...
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(painel_etapaLayout.createSequentialGroup()
        					.addComponent(etiqueta_label, GroupLayout.PREFERRED_SIZE, 427, GroupLayout.PREFERRED_SIZE)
        	...
        	painel_etapaLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(painel_etapaLayout.createSequentialGroup()
        			...
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(etiqueta_label, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
        				.addComponent(botao_eliminar, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addGap(60)
        			.addGroup(painel_etapaLayout.createParallelGroup(Alignment.BASELINE)
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(layout.createSequentialGroup()
        					.addGap(12)
        					.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 624, GroupLayout.PREFERRED_SIZE)
    ...
    private void botao_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_alterarActionPerformed
        ...
        this.alteracoes = 1;
        lista_actividades.setEnabled(false);
    ...
    private int delete_from_bd(String id){
        try{
            Connection con = (new Connection_bd(this.funcionario.get_username())).get_connection();
            String sql = "delete from tnm_trf_actividade where id = '" + id + "'" ;
            PreparedStatement ps=con.prepareStatement(sql);
            ps.executeUpdate();
            return 0;
        }
    ...
    @SuppressWarnings("rawtypes")
	private javax.swing.JList lista_actividades;

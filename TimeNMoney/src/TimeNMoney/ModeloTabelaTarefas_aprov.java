...
public class ModeloTabelaTarefas_aprov extends AbstractTableModel
{
    private final String[] columnNames;
    private final ArrayList<TarefaHoras> data; 
    private final TreeMap<String,Projecto> projectos;
    
    public ModeloTabelaTarefas_aprov(String[] columnNames, ArrayList<TarefaHoras> data, TreeMap<String,Projecto> proj){
